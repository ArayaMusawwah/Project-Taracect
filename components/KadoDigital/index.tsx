    ...
    <section className="relative flex min-h-lvh w-full items-center justify-center overflow-hidden text-center text-black">
      ...
      >
        <div className="sm:pt-18 relative h-[82vh] w-full bg-main-accent3 px-4 pt-4 sm:h-[70vh] sm:px-10">
          ...
          >
            <MotionH2
              className="mb-2 font-lobster text-3xl text-black sm:text-4xl"
              variants={variants}
            >
              Kado Digital
            </MotionH2>
            <MotionP
              className="text-balance font-libreBaskerville text-xs sm:text-sm"
              variants={variants}
            >
            ...
            <MotionDiv
              className="mx-auto mt-2 items-center justify-center px-6 max-md:flex max-md:flex-col max-md:gap-4 md:mt-8 md:grid md:grid-cols-2"
              variants={variants}
            >
